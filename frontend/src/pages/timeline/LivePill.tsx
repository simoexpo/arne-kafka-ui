...
// family), the active one highlighted: pause icon lit while live/unpaused,
// play icon lit while paused. `aria-pressed` mirrors `paused` — this is a
// pressed/unpressed toggle, not two separate buttons.

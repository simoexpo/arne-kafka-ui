          ...
          <span className="flex items-center gap-1.5">
            ...
            {version && (
              <a
                ...
                className="font-mono text-[10px] text-zinc-400 hover:underline dark:text-zinc-600"
              >
                {version}
              </a>
            )}
...
const REPO_URL = 'https://github.com/simoexpo/arne-kafka-ui'

function GitHubMark() {
  // The GitHub octicon mark (16x16).
  return (
